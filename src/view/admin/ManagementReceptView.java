...
public class ManagementReceptView extends javax.swing.JPanel {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
             new ManagementReceptView().setVisible(true);
            }
        });
    }
    ...
    private void productTblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_productTblMouseClicked
        ...
        String numstr = JOptionPane.showInputDialog(deleteBtn, "Nhập số lượng sản phẩm cần mua");
        if(numstr!=null && !numstr.trim().equals("")){
            try {
                int num=Integer.parseInt(numstr);
                if(num>quantity)
                JOptionPane.showConfirmDialog(deleteBtn, "Số lượng hàng không đủ");
                else{
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtnActionPerformed
        ...
        try {
            ...
            JOptionPane.showConfirmDialog(deleteBtn, "Thêm hóa đơn thành công");
            orders.add(order);
            setNullTextField();
            
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(deleteBtn, "Hay nhap du thong tin");
        } catch (Exception e) {
    ...
    private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtnActionPerformed
        ...
        if(status.equals(cbxstatus.getItemAt(0))){
            ...
            for(OrderDetail item: orderDetails){
                if((Objects.equals(item.getOrderID(), OrderID))){
                    ...
                    for(int i=0; i<=products.size()-1;i++){
                        if(Objects.equals(products.get(i).getmaSP(), item.getProductID())){

                            products.get(i).setSoLuong(products.get(i).getSoLuong()+item.getQuantity());
            ...
            orders.remove(row);
            fileController.updatelistOrderToFile("order.txt",orders);
            JOptionPane.showConfirmDialog(deleteBtn,"Đã xóa hóa đơn");
            setNullTextField();
        }
        else{
